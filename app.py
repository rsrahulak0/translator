...
#icon
image_icon=PhotoImage(file="resources/arrow.png")
root.iconphoto(False, image_icon)

#arrow
arrow_image = PhotoImage(file="resources/arrow.png")
...
label1 = Label(root, text="ENGLISH", font="sagoe 30 bold", bg="white", width=18, bd=5, relief=GROOVE)
...
label2 = Label(root, text="ENGLISH", font="sagoe 30 bold", bg="white", width=18, bd=5, relief=GROOVE)
